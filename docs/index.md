...
- **[Architecture Review](architecture.md):** Deep dive into the modular structure, object domains, and the pool failover strategies.
- **[How to Use (Examples & Tool Calling)](how-to-use.md):** Extensive recipes on handling single LLM runs, pools, and tool registry integrations.
